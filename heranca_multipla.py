...
Herança Múltipla nada mais é do que a possibilidade de uma classe herdar de múltiplas classes, fazendo com que a classe filha
...
vai herdar todos os atributos e métodos das super classes.
...
print(f'Tux é instância de Pinguim? {isinstance(tux, Aquatico)}') # True
print(f'Tux é instância de Pinguim? {isinstance(tux, Terrestre)}') # True
print(f'Tux é instância de Pinguim? {isinstance(tux, Animal)}') # True
print(f'Tux é instância de Pinguim? {isinstance(tux, object)}') # True
