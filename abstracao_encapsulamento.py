...
Imagina que temos uma classe chamado Pessoa, contendo um atributo privado chamado __nome e um
...
este acesso fora da classe. Com Python acontece um fenômeno chamado Name Mangling, que faz uma alteração
