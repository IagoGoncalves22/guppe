...
retorno_pr = print(numeros)

print(f'Retorno de print: {retorno_pr}')
...
OBS: Não precisamos necessariamente cirar uma variável para receber o retorno
de uma função. Podemos passsar a execução da função para outras funções.

# Refaturando função para retornar valor (refaturar)
...
# Erros comuns na utilização do retorno, mas que na verdade não é erro mas
# sim codificação desnecessária.
