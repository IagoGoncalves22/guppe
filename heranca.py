...
Perguntar: Existe alguma entidade genérica o suficiente para encapsular os atributos e métodos comuns a outras entidades?
...
Ocorre quando sobrescrevemos/reimplementamos um método presente na super classe em classes filhas.
...
# class Pinguim: # Não faz sentido, Pinguim não é uma pessoa, é categoria diferente
