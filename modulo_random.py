...
# que estiverem dentro do módulo ficarão disponíveis (Ficarão em memória). Caso você saiba
# quais funções precisa utilizar deste módulo, então esta não seria a forma ideal de utilização.
# Nós veremos uma forma melhor na forma 2.

print(random.random())

# Veja que para utilizar a função random() do pacote random, nós colocamos o nome do pacote e o
