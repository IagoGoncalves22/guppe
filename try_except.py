...
Prevenindo assim que o programa pare de funcionar e o usuário receba mensagens de
erro inesperadas.
...
# Tente executar a função geek(), caso você encontre erros, imprima amensagem
# de erro.
...
# Exemplo 5 - Tratando um erro específico com detalhes do err
