...
# OBS: O zip() utiliza como parâmetro o menor tamanho em iterável. Isso significa
# que se estiver trabalhando com iteráveis de tamanhos diferentes, irá parar quando
# os elementos do menor iterável acabar.
