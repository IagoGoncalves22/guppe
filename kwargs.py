...
Poderíamos chamar este paâmetro de **xix, mas por convenção chamamos de **kwargs

Este é só mais um parâmetro, mas diferente do *args que coloca  os valores extras
em uma tupla, o **kwargs exige que utilizemos parâmetros nomeados, que transforma
...
# OBS: Os parâmeros *args e **kwargs não são obrigatórios.
...
# Entenda por quê é importante manter a ordem dos parâmetros na declaraão
...
# OBS! os nomes da chave em um dicionário devem ser os mesmos dos
...
soma_multiplos_numeros(**dicionario, nome='Python')
