...
funções como argumentos para outras funções e até mesmo criar variáveis do tipo de
...
# como Nested Functions ou também Inner Functions (Funções Internas).
...
def faz_me_rir():
    def rir():
        return choice(('hahahahaha', 'kkkkkkkkk', 'yayayayayaya'))
    return rir
...
def faz_me_rir_novamente(pessoa):
    def dando_risada():
        risada = choice(('hahahaha', 'llololololo', 'kkkkkkkkkk'))
