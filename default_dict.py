...
um valor default podendo utilizar um lambda para isso. Esse valor será
utilizado sempre que não houver um valor definido. Caso tentemos acessar
ma chave que não existe, essa chave será criada e o valor default será atribuido.
