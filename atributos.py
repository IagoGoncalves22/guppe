...
# Atributo de instância: são atributos declarados dentro do métido constutor.

# OBS: Método construtor: é um método especial utilizado para a construção de um objeto.
...
# OBS: Lembre-se de que isso é apenas uma convenção. A linguagem Python não
...
print(dir(user._Acesso__senha)) # Temos acesso. Mas não deveríamos fazer esse acesso. Name Mangling.
...
# Significa, que ao criarmos instâncias/objetos de uma class, todas as instâncias terão estes atributos.
...
# Atributos de classe, são atributos, claro, que são declarados diretamente na class, ou seja,
...
# OBS: Em linguagens como o Java, os atributos conhecidos como atibutos de classe
...
# OBS: O aributo dinâmico será excluiso da instância que o criou.
...
print(f'Produto: {p2.nome}, Descritção: {p2.descricao}, Valor: {p2.valor}, Peso: {p2.peso}')

# print(f'Produto: {p1.nome}, Descritção: {p1.descricao}, Valor: {p1.valor}, Peso: {p1.peso}')
